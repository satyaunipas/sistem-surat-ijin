...
class AdminDataProdiController extends Controller
{
    /**
    ...
    public function index()
    {
       // Ambil jurusan_id dari admin yang login
        ...
        // Ambil prodi yang hanya di bawah jurusan yang sama dengan admin
        $prodis = Prodi::with('jurusan')
                    ->where('jurusan_id', $adminJurusanId)
                    ->get();

        return view('admin.data_prodi', compact('prodis'));
    }
    /**
