...
class SuperAdminDataMahasiswaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('super_admin.data_mahasiswa', compact('mahasiswas'));
    }
    ...
    {
        return view ('super_admin.tambah_mahasiswa', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/super_admin/data-mahasiswa')->with('success', 'Tambah data mahasiswa berhasil!');
    }
    ...
    public function show($username)
    {
        ...
        return view('super_admin.detail_mahasiswa', compact('mahasiswa'));
    }
    ...
    public function edit($username)
    {
        ...
        return view('super_admin.edit_mahasiswa', [
            'jurusans' => Jurusan::all(),
            'prodis' => Prodi::all(),
    ...
    public function update(Request $request, $username)
    {
        ...
        return redirect('/super_admin/data-mahasiswa')->with('success', 'Data mahasiswa berhasil diupdate.');
    }
    ...
    public function destroy($username)
    {
        ...
        return redirect('/super_admin/data-mahasiswa')->with('success', 'Berhasil menghapus data mahasiswa!');
    }
}
