        ...
        <div class="bg-image" style="background-image: url('{{ asset('media/photos/photo10@2x.jpg') }}');">
          <div class="bg-primary-dark-op">
            <div class="content content-full text-center">
              ...
              <a class="btn btn-alt-secondary" href="/admin/data-dosen">
                        ...
                        <div class="row push">
                          ...
                          <div class="col-lg-8 col-xl-5">
                            <div class="mb-4">
                              ...
                              <input type="text" class="form-control" id="one-profile-edit-username" name="one-profile-edit-username" value="{{ $dosen->username }}" disabled>
                            </div>
                            <div class="mb-4">
                              <label class="form-label" for="one-profile-edit-name">Name</label>
                              <input type="text" class="form-control" id="one-profile-edit-name" name="one-profile-edit-name"  value="{{ $dosen->name }}" disabled>
                            </div>
                            <div class="mb-4">
                              <label class="form-label" for="one-profile-edit-name">NIP</label>
                              <input type="text" class="form-control" id="one-profile-edit-name" name="one-profile-edit-name"  value="{{ $dosen->nomor_induk }}" disabled>
                            </div>
                            <div class="mb-4">
                              <label class="form-label" for="one-profile-edit-name">Alamat</label>
                              <input type="text" class="form-control" id="one-profile-edit-alamat" name="one-profile-edit-alamat"  value="{{ $dosen->alamat }}" disabled>
                            </div>
                            <div class="mb-4">
                              <label class="form-label" for="one-profile-edit-email">Email Address</label>
                              <input type="email" class="form-control" id="one-profile-edit-email" name="one-profile-edit-email" value="{{ $dosen->email }}" disabled>
                            </div>
                            <div class="mb-4">
                              <label class="form-label" for="one-profile-edit-name">Jurusan</label>
                              <input type="text" class="form-control" id="one-profile-edit-name" name="one-profile-edit-name"  value="{{ $dosen->jurusan->name }}" disabled>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                              <a href="/admin/data-dosen/{{ $dosen->username }}/edit" class="btn btn-alt-primary">
                                Edit Data Dosen
                              </a>
                            </div>
                          </div>
