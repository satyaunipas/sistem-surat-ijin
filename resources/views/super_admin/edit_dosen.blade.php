                ...
                <div class="content content-boxed">
                  ...
                  <div class="block block-rounded">
                    <div class="block-header block-header-default">
                      <h3 class="block-title">Form Edit Data Dosen</h3>
                    </div>
                    <div class="block-content">
                      <form action="/super_admin/data-dosen/{{ $dosen->username }}" method="POST" >
                        @method('put')
                        @csrf
                        <div class="row push">
                          <div class="col-lg-4">
                          ...
                          <div class="col-lg-8 col-xl-5">
                            <div class="mb-4">
                              <label class="form-label" for="name">Nama Dosen</label>
                              <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $dosen->name) }}">
                              @error('name')
                            ...
                            <div class="mb-4">
                              ...
                              <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username', $dosen->username) }}">
                              @error('username')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
                            ...
                            <div class="mb-4">
                              ...
                              <input type="text" class="form-control @error('nomor_induk') is-invalid @enderror" id="nomor_induk" name="nomor_induk" value="{{ old('nomor_induk', $dosen->nomor_induk) }}">
                              @error('nomor_induk')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
                            ...
                            <div class="mb-4">
                              ...
                              <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" value="{{ old('alamat', $dosen->alamat) }}">
                              @error('alamat')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
                            ...
                            <div class="mb-4">
                              ...
                              <input type="text" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number" value="{{ old('phone_number', $dosen->phone_number) }}">
                              @error('phone_number')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
                            ...
                            <div class="mb-4">
                              ...
                              <select class="form-select @error('jurusan_id') is-invalid @enderror" id="jurusan_id" name="jurusan_id">
                                  ...
                                  @foreach ( $jurusans as $jurusan)
                                    @if(old('jurusan_id', $dosen->jurusan_id) == $jurusan->id)
                            ...
                            <div class="mb-4">
                              ...
                              <select class="form-select @error('program_study_id') is-invalid @enderror" id="program_study_id" name="program_study_id" >
                                  ...
                                  @foreach ( $prodis as $prodi)
                                    @if(old('program_study_id', $dosen->program_study_id) == $prodi->id)
